...
payload['val_tpl'] ='{{value_json.Temperature | is_defined}}'
...
payload['val_tpl'] ='{{value_json.Illuminance | is_defined}}'
payload['force_update'] = 'true'
...
payload['val_tpl'] ='{{value_json.Moisture | is_defined}}'
payload['force_update'] = 'true'
...
payload['val_tpl'] ='{{value_json.Fertility | is_defined}}'
payload['force_update'] = 'true'
...
payload['val_tpl'] ='{{value_json.Battery | is_defined}}'
payload['force_update'] = 'true'
payload['unit_of_meas'] = '%'
...
payload['val_tpl'] ='{{value_json.RSSI | is_defined}}'
payload['force_update'] = 'true'
...
payload['val_tpl'] ='{{value_json.mac | is_defined}}'
payload['expire_after'] = '86400'
payload['dev'] = {'ids' : [f'miflora_{mac}']}
mqtt_client.publish(topic, json.dumps(payload), 1, retain=True)
...
payload['val_tpl'] ='{{value_json.Firmware | is_defined}}'
payload['expire_after'] = '86400'
payload['dev'] = {'ids' : [f'miflora_{mac}']}
mqtt_client.publish(topic, json.dumps(payload), 1, retain=True)
